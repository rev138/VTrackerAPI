...
#
# Note that settings in vtrackerapi.conf (or other external
...
VTrackerAPI - Catalyst based application

=head1 SYNOPSIS

    script/vtrackerapi_server.pl
...
L<VTrackerAPI::Controller::Root>, L<Catalyst>
